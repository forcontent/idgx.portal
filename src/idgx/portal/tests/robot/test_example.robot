...
#
#  $ bin/test -s idgx.portal -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src idgx.portal.testing.IDGX_PORTAL_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/idgx/portal/tests/robot/test_example.robot
#
